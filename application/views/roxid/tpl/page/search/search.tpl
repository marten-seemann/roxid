...
[{assign var='rsslinks' value=$oView->getRssLinks() }]
  ...
  <div class="page-header">
    <h1>
      ...
      [{if $rsslinks.searchArticles}]
        <a class="rss js-external" id="rssSearchProducts" href="[{$rsslinks.searchArticles.link}]" title="[{$rsslinks.searchArticles.title}]">[{$oViewConf->getRoxidIcon('rss')}]</a>
      [{/if}]
    </h1>
  </div>
  ...
  [{if $oView->getArticleCount() }]
    <div class="z-productlist-controls">
